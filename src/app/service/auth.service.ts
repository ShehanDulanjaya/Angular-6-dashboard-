...
tok = localStorage.getItem("tokenid");
  ...
  delProject(pid:any){
    ...
    return this.http.delete('http://localhost:3000/projects/'+pid, { headers: headers})
  }
  ...
  getOthercount(userId:any){
    const headers = new HttpHeaders({'Content-Type': 'application/json; charset=utf-8','authorization':'Bearer '+this.tok});
    //headers.append('authorization',token);
   // return this.http.get('http://localhost:3000/projectmem/count/'+userId, { headers: headers})
